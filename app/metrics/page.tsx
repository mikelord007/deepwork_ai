    ...
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <a href="/dashboard" className="flex items-center gap-2 text-muted hover:text-foreground transition-colors">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Focus Metrics</h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-muted mb-6">Complete your first focus session to see metrics here.</p>
            <a href="/dashboard" className="btn-primary inline-flex">
              Start Focusing
            </a>
          </div>
                  ...
                  <div key={h.hour} className="flex-1 flex flex-col items-center gap-1">
                    <div
                      className={`w-full rounded-t transition-all duration-300 ${
                        h.sessions > 0 ? "bg-primary" : "bg-gray-100"
                      }`}
                      style={{ 
